      ...
      <div className="p-6 bg-white shadow-md rounded-2xl">
        ...
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500">Información de tu cuenta en el sistema AAUD.</p>
          </div>
        </div>
        ...
        <div className="grid gap-4 mb-6 md:grid-cols-2">
          <div className="p-3 border rounded-xl bg-gray-50">
            ...
            <p className="mt-1 text-sm font-semibold text-gray-800">{loggedUserName}</p>
          </div>

          <div className="p-3 border rounded-xl bg-gray-50">
            <p className="text-xs font-medium text-gray-500 uppercase">Usuario</p>
            <p className="mt-1 text-sm font-semibold text-gray-800">{username || '—'}</p>
          </div>
        ...
        <div className="pt-4 mt-2 border-t border-gray-200">
          ...
          {showPasswordForm && (
            <div className="mt-3 animate-fadeIn">
              <ChangePasswordForm userId={loggedUserId} onLogout={logout} />
            </div>
          )}
        </div>
      </div>
