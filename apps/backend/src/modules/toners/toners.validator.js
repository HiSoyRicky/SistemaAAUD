...
const updateTonerBodySchema = z
  .object({
    id_printer_model: zOptionalInt('Modelo de impresora inválido', { min: 1 }),
    color: z
      .any()
      .optional()
      .refine((value) => value === undefined || TONER_COLORS.includes(value), {
...
export { validateCreateToner, validateDeleteToner, validateUpdateToner };
