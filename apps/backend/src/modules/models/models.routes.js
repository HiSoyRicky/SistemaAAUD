...
router.post('/', requirePermission('models.create'), validateCreateModel, controller.create);
router.put('/:id', requirePermission('models.update'), validateUpdateModel, controller.update);
router.delete('/:id', requirePermission('models.delete'), validateDeleteModel, controller.remove);
